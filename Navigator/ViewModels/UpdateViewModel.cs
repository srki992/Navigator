...
{
    public class UpdateViewModel : INotifyPropertyChanged, IUpdateViewModel
    {
        //KandidatiService ObjKandidatiService;
        IKandidatiService ObjKandidatiService;
        public UpdateViewModel(IKandidatiService ObjKandidatiService)
        {
            this.ObjKandidatiService = ObjKandidatiService;
            //ObjKandidatiService = new KandidatiService();
            _SaveCommand = new RelayCommand(Update);
            EndDate = DateTime.Today;
        }
        public delegate void OnDatabaseSubmit(); 
        public static event OnDatabaseSubmit Osvezi;
